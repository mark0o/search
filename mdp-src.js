...
function getQueryValue() {
  ...
  const result = queryValue ? queryValue : '';
...
/* Look for any elements with the class "mdp-dropdown": */
...
function ecosia() {
  ...
  window.location.href = `https://www.ecosia.org/search?q=${query}`
}

function ai() {
  const query = document.getElementById("text").value
  window.location.href = `https://www.perplexity.ai/search/new?q=${query}`
}
